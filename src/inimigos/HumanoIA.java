 ...
 * @author unipampa
 */
public class HumanoIA extends Inimigo{

    public HumanoIA(String nome, int inteligencia, int resistencia, int forca, int agilidade, int destreza, int bVida, Especialidade classeInimigo) {
